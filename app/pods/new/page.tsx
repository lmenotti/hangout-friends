  ...
  return (
    <div className="max-w-sm space-y-6">
      <div>
        ...
        <h1 className="text-xl font-semibold text-zinc-100 mt-2">New pod</h1>
        <p className="text-sm text-zinc-500 mt-1">An invite code is generated automatically.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          placeholder="Pod name (e.g. The Crew)"
